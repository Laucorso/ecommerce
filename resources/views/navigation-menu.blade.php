<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ url('/home') }}" :active="request()->is('home')" style="font-family: 'Oswald', sans-serif">
                        {{ __('Home') }}
                    </x-nav-link>
                    <x-nav-link href="{{ url('/products') }}" :active="request()->is('products')" style="font-family: 'Oswald', sans-serif">
                        {{ __('Products') }}
                    </x-nav-link>
                    <x-nav-link href="{{ url('/home') }}" :active="request()->routeIs('dashboard')" style="font-family: 'Oswald', sans-serif">
                        {{ __('Brands') }}
                    </x-nav-link>
                    <x-nav-link href="{{ url('/home') }}" :active="request()->routeIs('dashboard')" style="font-family: 'Oswald', sans-serif">
                        {{ __('Blog') }}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ url('/home') }}" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
